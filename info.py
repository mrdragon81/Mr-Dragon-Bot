...
# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(-1002912062084) else ch
    for ch in environ.get("CHANNELS", "-1003338128062").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003462919522"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1003462919522"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003434477634"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003434477634"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003434477634"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Dragon:Dragon@1206@cluster0.w4ctjak.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url")
...
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/kannadanewmoviea")
